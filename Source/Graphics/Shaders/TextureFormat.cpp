...
TextureFormat::TextureFormat(const char* filename)
{
...
// シェーダーリソースビューの設定
void TextureFormat::SetShaderResourceView(const Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& srv, int width, int height)
{
